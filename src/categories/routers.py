...
@categories_router.get('', name='Categories: List', status_code=status.HTTP_200_OK)
...
@categories_router.get('/{category_slug}', name='Categories: Get', status_code=status.HTTP_200_OK)
...
@categories_router.post('', name='Categories: Create', status_code=status.HTTP_201_CREATED)
...
@categories_router.patch('/{category_slug}', name='Categories: Update', status_code=status.HTTP_200_OK)
...
@categories_router.delete('/{category_slug}', name='Categories: Delete', status_code=status.HTTP_204_NO_CONTENT)
